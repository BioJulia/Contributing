...

{
    ...
    "title": "Contributing",
    "category": "section",
    "text": "(Image: Build Status)The core guidelines set out by the BioJulia community, for contributors, members, and maintainers. In addition to template files files for repositories.To start a discussion for a rule or guideline addition, make a PR or issue."
},
...

{
    ...
    "category": "section",
    "text": "You create a new branch for a new release. It branches off from master at the point that you decided master has all the necessary features. This is not necessarily the tip of the master branch.\nFrom then on new work, aimed for the _next_ release, is pushed to master as always, and any necessary changes for the _current_ release are pushed to the release branch. Once the release is ready, you tag the top of the release branch.\nOnce the release is ready, tag the top of the release branch with a version number. Then do a typical merge of the release branch into master. Any changes that were made during the release will now be part of master. Delete the release branch._Release Example:_git checkout -b release/2.3.0 9efc5d\n\n... Make commits to release/2.3.0 to finish the release ...\n\ngit tag 2.3.0\ngit checkout master\ngit merge release/2.3.0\ngit push --tags origin master\ngit branch -d release/2.3.0\ngit push origin :release/2.3.0Do your pushes, and go to GitHub to make your release available."
},
...

{
    ...
    "category": "section",
    "text": "Be welcoming. We strive to welcome and support any individual participating in BioJulia activities to any extent (from developing code, to support seeking users). We have even been known to have a few members on our Gitter who are not Biologists, but they enjoy the forum, like what we do, and stick around for the programming chat. All are welcome (yes including _you_! :smile:)."
},
...
{
    "location": "CHANGELOG.html#Unreleased-1",
    "page": "Changelog",
    "title": "Unreleased",
    "category": "section",
    "text": ""
...
{
    "location": "CHANGELOG.html#Added-1",
    "page": "Changelog",
    "title": "Added",
    "category": "section",
...
{
    "location": "CHANGELOG.html#Changed-1",
    "page": "Changelog",
    "title": "Changed",
    "category": "section",
    "text": "Contributing site generated from the symbolically linked files."
},
...
{
    "location": "AUTHORS.html#Authors-and-Contributors-1",
    "page": "Authors",
